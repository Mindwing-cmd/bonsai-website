...
/**
 * multi-type-ripple-buttons (easemize) – Ripple-Effekt-Button
 */
...
export const RippleButton: React.FC<RippleButtonProps> = ({
      ...
      {jsRipples.map((ripple) => (
        <span
          ...
          style={{
            ...
            ["--ripple-duration" as keyof CSSProperties]: `${rippleDuration}ms`,
          } as CSSProperties}
        />
      ))}
    </div>
  ...
  if (variant === "hover") {
    const hoverButtonFinalClassName = [
      "relative rounded-lg overflow-hidden isolate cursor-pointer border-none bg-transparent text-lg px-4 py-2",
